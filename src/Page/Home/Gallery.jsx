...
const Gallery = () => {
    ...
    const videos = [
        ...
        { id: 4, title: "মাদ্রাসা বিভাগের কার্যক্রম", date: "09 Jan, 2026", thumbnail: "/images/v4.jpg" },
    ];
            ...
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[#f3f4f6] rounded-3xl p-6 shadow-lg h-full">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button className="text-[#065f46] text-sm font-bold flex items-center gap-2 hover:underline">
                            সব দেখুন <FaArrowRight />
                        </button>
                    </div>
