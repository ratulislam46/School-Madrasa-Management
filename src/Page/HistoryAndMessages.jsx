                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            {galleryImages?.map((src, idx) => (
                                ...
                                >
                                    <img 
                                        src={src} 
                                        className="w-full h-full object-cover transition-all duration-500 group-hover:grayscale group-hover:scale-110 opacity-100 group-hover:opacity-70" 
                                        alt="Gallery"
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div className="flex flex-col items-end gap-3 w-full md:w-auto">
                            <span className="text-2xl md:text-3xl font-black text-[#065f46]">+880 1703 296544</span>
                            <button className="flex items-center gap-2 bg-[#065f46] hover:bg-[#044d39] text-white px-6 py-3 rounded-full text-sm font-bold shadow-lg transition-all cursor-pointer active:scale-95 w-full md:w-auto justify-center">
                            ...
                            <div key={item.id} className="p-4 border border-gray-50 rounded-2xl hover:bg-gray-50 transition-colors group">
                                <div className="flex items-center gap-4 mb-3">
                                    <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-green-100">
                                        <img src={item.image} className="w-full h-full object-cover" alt={item.name} onError={(e) => e.target.src='https://via.placeholder.com/100'} />
                                    </div>
                                    <div>
