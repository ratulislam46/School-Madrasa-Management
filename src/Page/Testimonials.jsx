...
const Testimonials = () => {
  ...
  return (
    <section className="bg-[#F3FAF6] py-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {reviews.map((item) => (
          <motion.div
            ...
            className="relative bg-white p-8 rounded-3xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] border border-gray-50 overflow-hidden group"
          >
            {/* Background Decorative Circles (Screenshot style) */}
