...
const MultiMedia = () => {
  // ফেসবুক পেজ এমবেড করার জন্য iframe src
  const fbPageUrl = "https://web.facebook.com/itbiponibd/?ref=embed_page#";
  const fbAppId = "YOUR_FB_APP_ID_IF_AVAILABLE"; // (ঐচ্ছিক) যদি আপনার FB অ্যাপ আইডি থাকে

  const fbEmbedSrc = `https://www.facebook.com/plugins/page.php?href=${encodeURIComponent(
    fbPageUrl
  )}&tabs=timeline&width=340&height=400&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=${fbAppId}`;
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col h-full transform transition hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div className="flex-grow p-2 flex items-center justify-center overflow-hidden">
                <iframe 
                    ...
                    className="fb-page-iframe w-full h-[380px] md:h-[400px]"
                >
                </iframe>
            </div>
          </div>
